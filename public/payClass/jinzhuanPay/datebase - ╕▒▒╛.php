...
class Datebase{
	...
	public $localhost = '192.157.177.4';//'192.168.223.22';
	public $username = 'root';
	public $password = 'sAskeji[lifa]2019*05';
	public $datebase = 'le10';
	public $port = '3306';


/*	public $localhost = '127.0.0.1';//'192.168.223.22';
	public $username = 'root';
	public $password = 'root';
	//public $password = 'sAskeji[dafa]2019*02';
	public $datebase = 'hdcp_le10';
	public $port = '3306';*/
	...
	public function runUpdate($array=array(),$isScan=false){
		...
		if(!$countReport['count(*)']){
	        $updateDaily = $this->db_insert($mysqli, 'ly_user_daily', array('uid'=>$array['uid'],'username'=>$username['username'],'date'=>$today,'recharge'=>$array['money']));
	    }else{
	...
	public function withDrawRun($array=array()){
		...
		if(!$countReport['count(*)']){
	        ...
	        $updateDaily = $this->db_insert($mysqli, 'ly_user_daily', array('uid'=>$array['uid'],'username'=>$userInfo['username'],'date'=>$today,'withdrawals'=>$array['price']));
	    }else{
