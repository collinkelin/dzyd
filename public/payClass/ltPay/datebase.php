...
class Datebase{
	...
	public $password = 'tkenWL6JzNrafXkx';
	public $datebase = 'dfx';
	public $port = '3306';
	/*public $localhost = '127.0.0.1';//'192.168.190.12';
	public $username = 'root';
...
/*		//检测银行信息
	...
	public function runUpdate($array=array(),$isScan=false){
		...
		//更新用户充值信息
		$updateUserRecharge = $this->db_update($mysqli, 'ly_user_recharge', $updateUserRechargeArray, array('order_number'=>$array['order_number'],'uid'=>$array['uid'],'state'=>3));
