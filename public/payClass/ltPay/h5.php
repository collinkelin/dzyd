...
switch ($param['scanType']) {
	case 'alipay':
		$productType =  931;//支付宝转银行卡扫码
		$productName = 'zfb';
		break;
	case 'weixin':
		$productType = 'pay_wechat';//微信扫码
		$productName = 'wechat';
		break;
	case 'ysf':
		$productType = 'pay_union';//云闪付
		$productName = 'ysf';
		break;
	case 'alipaya':
		$productType = 'pay_alipayqr';//支付宝扫码A
		$productName = 'alipaya';
		break;
	case 'alipayb':
...
// 提交地址
$submitUrl = 'http://www.xejpay.com/Pay_Index.html';//'http://yiapi.lianlianspc.com/gateway/bankgateway';//
