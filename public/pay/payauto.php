      ...
      <div class="Dialog">
        ...
        <div class="con">
          ...
          <div class="bottom">
            ...
            <img id="Icon" src="ali.png" width="150" style="display: none">
            <div class="code" id="QRCode"></div>
            <!-- <div class="tag">请勿重<br>复付款</div> -->
          </div>
          <div class="tips">一般10秒内可付款，请您耐心等待！</div>
          <div class="btn" id="AliPayUrl" style="display: none"><a href="" target="_blank">立即支付</a></div>
        </div>
      </div>
    </div>
...
function getTimingOrder(getcode){
  $.post('order/timingOrder',{orderId: paymentData.orderid},function(data){
    if(data.qrcodeurl){
      ...
      $('.PaymentPayment .tips,#cancelBtn,.Circle').remove();
      $('#Icon').show();
