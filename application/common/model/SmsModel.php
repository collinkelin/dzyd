   ...
   */
    ...
    */
	...
	//	}
		...
		$data['BaseUrl']	=	'http://sms.skylinelabs.cc:20003/sendsmsV2';
		...
		$data['content']	='क्या आपका सत्यापित कोड है';
		$data['content'] = $data['content'].$code.','.'30 मिनट के लिए वैध.कृपया इस संदेश को अनदेखा करें.';
		// 业务类型(可选)
		$data['svrtype']	=	'';
		// 设置扩展号(可选)
		$data['exno']		=	'';
